...
public class FriendsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mListener = (OnFriendFragmentInteractionListener) getActivity();
    }
    ...
    public void onStart() {
        ...
        DatabaseReference userRef = rootRef.child(mListener.getUID());
        ...
        friendsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    ...
                    friend.friendName = (String)dataSnapshot1.getValue();
...
//                Log.d("seize", arrayList.size() + "");
                ...
                FriendsAdapter friendsAdapter = new FriendsAdapter(arrayList,mListener.getUID(),getActivity());
